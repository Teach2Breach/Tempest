                ...
                if res == 0 {
                    ...
                    if !imp_token.is_empty() {
                        loop {
                            ...
                            ////println!("Headers: {}", headers.to_str().unwrap());
                            ////println!("Token: {}", imp_token);

                            //send blank request body, since we only care about the headers
                            //let request_body = CString::new("").unwrap();
                            ...
                            //need to add encryption to this request as well
